...
class TTSManager:
    def __init__(self, main_queue, route_queue, uart_queue, at_queue, log_queue, at_port, uart_port, version, imei, runtimes):
    ...
    def init(self):
        ...
        time.sleep(10)
        # 6. tts音频播放
        main_queue_data = self.route_queue_put('AT', 'tts_init', self.runtimes)
        if main_queue_data is False:
            return False
        # 7. 关闭AT口
