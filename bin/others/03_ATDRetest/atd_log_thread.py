...
class LogThread(Thread):
    ...
    def init_log_dir(self, info):
        ...
        init_df_column = ['runtimes_start_timestamp', 'runtimes', 'cfun_fail_times']
    ...
    #     """
        # 用作写入result_log时宽度设置
        # result_width_standard_1 = {0: ['local_time', 25], 1: ['runtimes', 10], 2: ['cfun_fail_times', 20]}
        #
        ...
        #
        # result_list = [local_time, runtimes, cfun_fail_times]
        #
