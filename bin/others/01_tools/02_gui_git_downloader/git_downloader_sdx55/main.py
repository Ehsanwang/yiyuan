...
class MainWindow(QMainWindow):
    ...
    def show_help_info(self):
        QMessageBox.information(self, '帮助', 'SDX55 Git下载工具，如有任何问题请联系 Flynn。', QMessageBox.Yes, QMessageBox.Yes)

    def update_combo_box(self):
        self.ui.combo_box_tag.clear()
        url = 'https://stgit.quectel.com/api/v4/projects/173/repository/tags?private_token=yzAJTSRxGVriiPDiEZ5V'
        r = requests.get(url)
        for item in r.json():
