...
# ======================================================================================================================
# 必选参数
uart_port = 'COM12'  # 定义串口号,用于控制DTR引脚电平或检测URC信息
at_port = 'COM59'  # 定义AT端口号,用于发送AT指令或检测URC信息
dm_port = 'COM58'  # 定义DM端口号,用于判断模块有无dump
debug_port = 'COM18'  # RM模块参数设置为''，但是需要连接跳线读取debug log，RG需要设置为DEBUG UART串口号
revision = 'RG520NEUDAR03A01M8G_OCPU_BCBCPE'  # 设置Revision版本号，填写ATI+CSUB查询的Revision部分
...
ping_times = 20 # 默认每个runtimes ping 100次
