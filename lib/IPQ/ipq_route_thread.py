...
class RouteThread(Thread):
    def __init__(self, route_queue, uart_queue, process_queue, at_queue, power_queue, ipq_queue):
        super().__init__()
    ...
    def power(self, param, evt):
        self.power_queue.put([param, evt])

    def ipq(self, param, evt):
        self.ipq_queue.put([param, evt])
