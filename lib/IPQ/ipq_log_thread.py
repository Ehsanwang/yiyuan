...
class LogThread(Thread):
    ...
    def init_log_dir(self, info):
        ...
        init_df_column = ['local_time', 'runtimes', 'data_interface_value_error_times', 'ipq_start_fail_times',
                          'ipq_pcie_check_fail_times']
    ...
    def write_result_log(self, runtimes):
        ...
        result_width_standard = {0: ['local_time', 25], 1: ['runtimes', 8],
                                 2: ['data_interface_value_error_times', 32], 3: ['ipq_start_fail_times', 20],
                                 4: ['ipq_pcie_check_fail_times', 25]}
        ...
        result_list = [local_time, runtimes, data_interface_value_error_times, ipq_start_fail_times,
                       ipq_pcie_check_fail_times]
