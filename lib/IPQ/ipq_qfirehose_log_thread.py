...
class LogThread(Thread):
    def __init__(self, version, info, log_queue, main_queue):
        ...
        self.handles = ['self.at_log_handle', 'self.dos_log_handle', 'self.debug_log_handle', 'self.result_log_handle',
                        'self.network_log_handle', 'self.qfirehose_log_handle', 'self.ipq_log_handle']
    ...
    def init_log_dir(self, info):
        ...
        init_df_column = ['local_time', 'runtimes', 'upgrade_fail_times', 'qfirehose_upgrade_a_b_starttimestamp',
                          'qfirehose_upgrade_a_b_endtimestamp', 'qfirehose_version_fail_times']
    ...
    def write_result_log(self, runtimes):
        ...
        :return: None
        """
        result_width_standard = {0: ['local_time', 25], 1: ['runtimes', 8], 2: ['upgrade_fail_times', 19],
                                 3: ['qfirehose_version_fail_times', 19], 4: ['qfirehose_upgrade_time', 19]}
        ...
        result_list = [local_time, runtimes, upgrade_fail_times, qfirehose_version_fail_times, qfirehose_upgrade_time]
